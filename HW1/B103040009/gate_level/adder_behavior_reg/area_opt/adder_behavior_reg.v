...
module adder_behavior_reg ( q, a, b, ci, clk );
  ...
  D_FF_32 dff_0_ ( .q(q[0]), .d(co_s[0]), .clk(clk) );
  D_FF_31 dff_1_ ( .q(q[1]), .d(co_s[1]), .clk(clk) );
  D_FF_30 dff_2_ ( .q(q[2]), .d(co_s[2]), .clk(clk) );
  D_FF_29 dff_3_ ( .q(q[3]), .d(co_s[3]), .clk(clk) );
  D_FF_28 dff_4_ ( .q(q[4]), .d(co_s[4]), .clk(clk) );
  D_FF_27 dff_5_ ( .q(q[5]), .d(co_s[5]), .clk(clk) );
  D_FF_26 dff_6_ ( .q(q[6]), .d(co_s[6]), .clk(clk) );
  D_FF_25 dff_7_ ( .q(q[7]), .d(co_s[7]), .clk(clk) );
  D_FF_24 dff_8_ ( .q(q[8]), .d(co_s[8]), .clk(clk) );
  D_FF_23 dff_9_ ( .q(q[9]), .d(co_s[9]), .clk(clk) );
  D_FF_22 dff_10_ ( .q(q[10]), .d(co_s[10]), .clk(clk) );
  D_FF_21 dff_11_ ( .q(q[11]), .d(co_s[11]), .clk(clk) );
  D_FF_20 dff_12_ ( .q(q[12]), .d(co_s[12]), .clk(clk) );
  D_FF_19 dff_13_ ( .q(q[13]), .d(co_s[13]), .clk(clk) );
  D_FF_18 dff_14_ ( .q(q[14]), .d(co_s[14]), .clk(clk) );
  D_FF_17 dff_15_ ( .q(q[15]), .d(co_s[15]), .clk(clk) );
  D_FF_16 dff_16_ ( .q(q[16]), .d(co_s[16]), .clk(clk) );
  D_FF_15 dff_17_ ( .q(q[17]), .d(co_s[17]), .clk(clk) );
  D_FF_14 dff_18_ ( .q(q[18]), .d(co_s[18]), .clk(clk) );
  D_FF_13 dff_19_ ( .q(q[19]), .d(co_s[19]), .clk(clk) );
  D_FF_12 dff_20_ ( .q(q[20]), .d(co_s[20]), .clk(clk) );
  D_FF_11 dff_21_ ( .q(q[21]), .d(co_s[21]), .clk(clk) );
  D_FF_10 dff_22_ ( .q(q[22]), .d(co_s[22]), .clk(clk) );
  D_FF_9 dff_23_ ( .q(q[23]), .d(co_s[23]), .clk(clk) );
  D_FF_8 dff_24_ ( .q(q[24]), .d(co_s[24]), .clk(clk) );
  D_FF_7 dff_25_ ( .q(q[25]), .d(co_s[25]), .clk(clk) );
  D_FF_6 dff_26_ ( .q(q[26]), .d(co_s[26]), .clk(clk) );
  D_FF_5 dff_27_ ( .q(q[27]), .d(co_s[27]), .clk(clk) );
  D_FF_4 dff_28_ ( .q(q[28]), .d(co_s[28]), .clk(clk) );
  D_FF_3 dff_29_ ( .q(q[29]), .d(co_s[29]), .clk(clk) );
  D_FF_2 dff_30_ ( .q(q[30]), .d(co_s[30]), .clk(clk) );
  D_FF_1 dff_31_ ( .q(q[31]), .d(co_s[31]), .clk(clk) );
  D_FF_0 dff_32_ ( .q(q[32]), .d(co_s[32]), .clk(clk) );
  adder_behavior_reg_DW01_add_0 add_1_root_add_12_2 ( .CI(ci), .SUM(co_s), 
