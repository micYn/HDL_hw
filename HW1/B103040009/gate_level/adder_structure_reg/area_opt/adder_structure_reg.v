...
module FA_0 ( sum, c_out, a, b, c_in );
  ...
  XOR2D1BWP16P90 U1 ( .A1(c_in), .A2(n1), .Z(sum) );
  AO22D1BWP16P90LVT U2 ( .A1(b), .A2(a), .B1(n1), .B2(c_in), .Z(c_out) );
...
module FA_1 ( sum, c_out, a, b, c_in );
  ...
  XOR2D1BWP16P90LVT U3 ( .A1(c_in), .A2(n2), .Z(sum) );
endmodule
...
module FA_2 ( sum, c_out, a, b, c_in );
  ...
  ND2D1BWP16P90LVT U2 ( .A1(n4), .A2(c_in), .ZN(n3) );
  ND2D1BWP16P90LVT U3 ( .A1(n2), .A2(n3), .ZN(c_out) );
  XOR2D1BWP16P90LVT U4 ( .A1(c_in), .A2(n4), .Z(sum) );
...
module FA_3 ( sum, c_out, a, b, c_in );
  ...
  AO22D1BWP16P90LVT U1 ( .A1(b), .A2(a), .B1(n2), .B2(c_in), .Z(c_out) );
